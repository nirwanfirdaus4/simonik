...
<div class="page-content">
  ...
  <div class="page-header no-margin-bottom">
    <div class="container-fluid">
      <h2 class="h5 no-margin-bottom">Data Anggota</h2>
    </div>
  </div>
  <!-- Breadcrumb-->
  <div class="container-fluid">
  ...
  <div class="col-lg-12">
    <div class="block">
      ...
      <a href="<?php echo base_url('superadmin/Data_angggota/tambahData/') ?> "><button type="button" class="btn btn_dewe space_add">Tambah Data</button></a>
      <div class="table-responsive"> 
        <table class="table table-striped table-sm" id="myTable">
          ...
          <tbody>
            $id_ukm=$this->session->userdata('ses_id_ukm');            
            <?php $no=1; $modal=0; ?>
