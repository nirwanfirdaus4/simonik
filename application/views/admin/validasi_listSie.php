        ...
        <table class="table table-striped table-sm" id="myTable">
          <thead>
            <tr>
              ...
              <th style="color: #111">Total Jobdesk</th>
          ...
          <tbody>
            ...
            <?php foreach ($array as $key) { ?>
              ...
              <tr>
                ...
                <?php
                $sie=$key['id_sie'];
                $query_jobdesk = $this->db->query("SELECT * FROM tb_jobdesk where id_proker=$revisi_proker AND id_sie=$sie");
                $hit_jobdesk=$query_jobdesk->num_rows();
                ?>
                <td style="color: #111"><?php echo $hit_jobdesk ?></td>
                <td style="color: #111">
                  <a href="<?php echo base_url('admin/Data_proker/validasi_jobdesk/' .$id_proker."/". $key['id_sie']) ?>" title="Lihat sie"><button type="button" class="btn btn-success"><i class="fa fa-eye"></i></button></a>
                </td>
              <?php } ?>
              </tr>
