...
<div class="page-content">
  ...
  <div class="col-lg-12">
    <div class="block">
      <div class="title"><strong style="color: #111">Ubah Data User</strong></div>
      ...
      <div class="block-body">
        <form action="<?php echo base_url('admin/Data_user/edit/'.$data[0]['id_user']) ?> " method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label style="color: #111" class="form-control-label">Nama user</label>
          ...
          <div class="form-group">
            <label style="color: #111" class="form-control-label">Telp user</label>
          ...
          <?php 
            ...
            <?php } else{ ?>
              <div class="form-group">
              <label style="color: #111" class="form-control-label">Tiper user</label>
